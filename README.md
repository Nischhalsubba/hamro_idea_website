...
- [`README.md`](https://github.com/Nischhalsubba/hamro_idea_website/blob/develop/README.md)
...
flowchart TD
    ...
    ROOT --> P13["work/"]
    ROOT --> P14[".DS_Store"]
    ROOT --> P15[".editorconfig"]
    ROOT --> P16[".gitignore"]
    ROOT --> P17["cookie-consent.html"]
    ROOT --> MORE["+ 11 more top-level entries"]
```

| Responsibility | Detected source paths |
|---|---|
| Interface | [`templates`](https://github.com/Nischhalsubba/hamro_idea_website/tree/develop/templates), [`src`](https://github.com/Nischhalsubba/hamro_idea_website/tree/develop/src) |
| Application logic | [`services`](https://github.com/Nischhalsubba/hamro_idea_website/tree/develop/services) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/hamro_idea_website/tree/develop/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/hamro_idea_website/tree/develop/.github) |
...
- [`.github/workflows/npm_publish.yml`](https://github.com/Nischhalsubba/hamro_idea_website/blob/develop/.github/workflows/npm_publish.yml)
- [`.github/workflows/tests.yml`](https://github.com/Nischhalsubba/hamro_idea_website/blob/develop/.github/workflows/tests.yml)
...
| License | [`LICENSE`](https://github.com/Nischhalsubba/hamro_idea_website/blob/develop/LICENSE) |
